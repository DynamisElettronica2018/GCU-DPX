...
;aac.c,130 :: 		void aac_updateParam(const aac_params id, const int value){
;aac.c,131 :: 		if(id < AAC_NUM_PARAMS)
	CP.B	W10, #11
	BRA LTU	L__aac_updateParam59
	GOTO	L_aac_updateParam22
L__aac_updateParam59:
;aac.c,132 :: 		aac_parameters[id] = value;
	ZE	W10, W0
	SL	W0, #1, W1
	MOV	#lo_addr(_aac_parameters), W0
	ADD	W0, W1, W0
...
;aac.c,135 :: 		void aac_stop(void){
;aac.c,136 :: 		if(aac_currentState != OFF)
	MOV	#lo_addr(_aac_currentState), W0
	MOV.B	[W0], W0
	CP.B	W0, #0
	...
	GOTO	L_aac_stop23
L__aac_stop61:
;aac.c,137 :: 		aac_currentState = STOPPING;
	MOV	#lo_addr(_aac_currentState), W1
	MOV.B	#6, W0
	MOV.B	W0, [W1]
L_aac_stop23:
...
;aac.c,140 :: 		void aac_updateExternValue(const aac_values id, const int value){
;aac.c,141 :: 		if(id < AAC_NUM_VALUES)
	CP.B	W10, #3
	BRA LTU	L__aac_updateExternValue63
	GOTO	L_aac_updateExternValue24
L__aac_updateExternValue63:
;aac.c,142 :: 		aac_externValues[id] = value;
	ZE	W10, W0
	SL	W0, #1, W1
	MOV	#lo_addr(_aac_externValues), W0
	ADD	W0, W1, W0
...
;aac.c,145 :: 		int aac_getParam(const aac_params id){
;aac.c,146 :: 		if(id < AAC_NUM_PARAMS)
	CP.B	W10, #11
	BRA LTU	L__aac_getParam65
	GOTO	L_aac_getParam25
L__aac_getParam65:
;aac.c,147 :: 		return aac_parameters[id];
	ZE	W10, W0
	SL	W0, #1, W1
	MOV	#lo_addr(_aac_parameters), W0
	ADD	W0, W1, W0
