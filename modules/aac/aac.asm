...
;aac.c,29 :: 		aac_currentState = READY;
	MOV	#lo_addr(_aac_currentState), W1
	MOV.B	#2, W0
	MOV.B	W0, [W1]
;aac.c,30 :: 		aac_clutchValue = 100;
	MOV	#0, W0
	MOV	#17096, W1
	MOV	W0, _aac_clutchValue
	MOV	W1, _aac_clutchValue+2
;aac.c,31 :: 		Clutch_set((unsigned int)aac_clutchValue);
	MOV	#0, W0
	MOV	#17096, W1
	CALL	__Float2Longint
	MOV.B	W0, W10
	CALL	_Clutch_set
;aac.c,32 :: 		accelerationFb = 1;
	MOV	#1, W0
	MOV	W0, _accelerationFb
;aac.c,33 :: 		sendUpdatesSW(ACC_CODE);
	MOV	#1, W10
	CALL	_sendUpdatesSW
;aac.c,34 :: 		return;
...
;aac.c,43 :: 		aac_currentState = RELEASING;
	...
	MOV.B	#4, W0
	MOV.B	W0, [W1]
;aac.c,44 :: 		accelerationFb = 2;
	MOV	#2, W0
	MOV	W0, _accelerationFb
;aac.c,45 :: 		sendUpdatesSW(ACC_CODE);
	MOV	#1, W10
	CALL	_sendUpdatesSW
;aac.c,46 :: 		return;
	GOTO	L_end_aac_execute
;aac.c,47 :: 		case RELEASING:
L_aac_execute5:
;aac.c,49 :: 		aac_clutchValue = aac_clutchValue - aac_clutchStep;
	...
	MOV	W0, _aac_clutchValue
	MOV	W1, _aac_clutchValue+2
;aac.c,50 :: 		Clutch_set((unsigned char)aac_clutchValue);
	CALL	__Float2Longint
	MOV.B	W0, W10
	CALL	_Clutch_set
;aac.c,51 :: 		aac_dtRelease--;
	MOV	#1, W1
	MOV	#lo_addr(_aac_dtRelease), W0
	SUBR	W1, [W0], [W0]
;aac.c,52 :: 		if(aac_dtRelease <= 0 || Clutch_get() <= aac_parameters[RAMP_END]){
	MOV	_aac_dtRelease, W0
	CP	W0, #0
	BRA GT	L__aac_execute28
...
L__aac_execute23:
L__aac_execute22:
;aac.c,53 :: 		Clutch_set(0);
	CLR	W10
	CALL	_Clutch_set
;aac.c,54 :: 		Efi_unsetRPMLimiter();
	CALL	_Efi_unsetRPMLimiter
;aac.c,55 :: 		aac_currentState = RUNNING;                 //For gearshift  Use alternatively to aac_stop
	MOV	#lo_addr(_aac_currentState), W1
	MOV.B	#5, W0
	MOV.B	W0, [W1]
;aac.c,58 :: 		}
...
;aac.c,60 :: 		return;
	GOTO	L_end_aac_execute
;aac.c,61 :: 		case RUNNING:
L_aac_execute9:
;aac.c,63 :: 		if(gearShift_currentGear == 4){
	MOV	_gearShift_currentGear, W0
	CP	W0, #4
	BRA Z	L__aac_execute30
...
;aac.c,66 :: 		}
L_aac_execute10:
;aac.c,68 :: 		if(aac_externValues[RPM] >= aac_parameters[RPM_LIMIT_1_2 + gearShift_currentGear - 1]
	MOV	_gearShift_currentGear, W0
	ADD	W0, #3, W0
	DEC	W0
	SL	W0, #1, W1
	...
	ADD	W0, W1, W0
	MOV	[W0], W1
;aac.c,69 :: 		&& aac_externValues[WHEEL_SPEED] >= aac_parameters[SPEED_LIMIT_1_2 + gearShift_currentGear - 1]){
	MOV	#lo_addr(_aac_externValues), W0
	CP	W1, [W0]
	BRA LE	L__aac_execute31
...
;aac.c,72 :: 		return;
	GOTO	L_end_aac_execute
;aac.c,73 :: 		case STOPPING:
L_aac_execute14:
;aac.c,74 :: 		aac_currentState = OFF;
	MOV	#lo_addr(_aac_currentState), W1
	CLR	W0
	MOV.B	W0, [W1]
;aac.c,75 :: 		accelerationFb = 0;
	CLR	W0
	MOV	W0, _accelerationFb
;aac.c,76 :: 		sendUpdatesSW(ACC_CODE);
	MOV	#1, W10
	CALL	_sendUpdatesSW
;aac.c,77 :: 		return;
	GOTO	L_end_aac_execute
;aac.c,79 :: 		default: return;
L_aac_execute15:
	GOTO	L_end_aac_execute
;aac.c,80 :: 		}
L_aac_execute0:
...
;aac.c,136 :: 		void aac_stop(void){
;aac.c,137 :: 		if(aac_currentState != OFF)
	MOV	#lo_addr(_aac_currentState), W0
	MOV.B	[W0], W0
	CP.B	W0, #0
	BRA NZ	L__aac_stop41
	GOTO	L_aac_stop16
L__aac_stop41:
;aac.c,138 :: 		aac_currentState = STOPPING;
	MOV	#lo_addr(_aac_currentState), W1
	MOV.B	#6, W0
	MOV.B	W0, [W1]
L_aac_stop16:
...
;aac.c,141 :: 		void aac_updateExternValue(const aac_values id, const int value){
;aac.c,142 :: 		if(id < AAC_NUM_VALUES)
	CP.B	W10, #3
	BRA LTU	L__aac_updateExternValue43
	GOTO	L_aac_updateExternValue17
L__aac_updateExternValue43:
;aac.c,143 :: 		aac_externValues[id] = value;
	ZE	W10, W0
	SL	W0, #1, W1
	MOV	#lo_addr(_aac_externValues), W0
	ADD	W0, W1, W0
...
;aac.c,146 :: 		int aac_getParam(const aac_params id){
;aac.c,147 :: 		if(id < AAC_NUM_PARAMS)
	CP.B	W10, #9
	BRA LTU	L__aac_getParam45
	GOTO	L_aac_getParam18
L__aac_getParam45:
;aac.c,148 :: 		return aac_parameters[id];
	ZE	W10, W0
	SL	W0, #1, W1
	MOV	#lo_addr(_aac_parameters), W0
	ADD	W0, W1, W0
...
;aac.c,152 :: 		int aac_getExternValue(const aac_params id){
;aac.c,153 :: 		if(id < AAC_NUM_VALUES)
	CP.B	W10, #3
	BRA LTU	L__aac_getExternValue47
	GOTO	L_aac_getExternValue19
L__aac_getExternValue47:
;aac.c,154 :: 		return aac_externValues[id];
	ZE	W10, W0
	SL	W0, #1, W1
	MOV	#lo_addr(_aac_externValues), W0
	ADD	W0, W1, W0
