...
;aac.c,139 :: 		aac_parameters[SPEED_LIMIT_1_2] = DEF_SPEED_LIMIT_1_2;
	MOV	#47, W0
	MOV	W0, _aac_parameters+12
;aac.c,140 :: 		aac_parameters[SPEED_LIMIT_2_3] = DEF_SPEED_LIMIT_2_3;
	MOV	#65, W0
	MOV	W0, _aac_parameters+14
;aac.c,141 :: 		aac_parameters[SPEED_LIMIT_3_4] = DEF_SPEED_LIMIT_3_4;
	MOV	#80, W0
...
;aac.c,145 :: 		void aac_updateParam(const aac_params id, const int value){
;aac.c,146 :: 		if(id < AAC_NUM_PARAMS)
	CP.B	W10, #9
	BRA LTU	L__aac_updateParam59
	GOTO	L_aac_updateParam22
L__aac_updateParam59:
;aac.c,147 :: 		aac_parameters[id] = value;
	ZE	W10, W0
	SL	W0, #1, W1
	MOV	#lo_addr(_aac_parameters), W0
	ADD	W0, W1, W0
...
;aac.c,150 :: 		void aac_stop(void){
;aac.c,151 :: 		if(aac_currentState != OFF)
	MOV	#lo_addr(_aac_currentState), W0
	MOV.B	[W0], W0
	CP.B	W0, #0
	...
	GOTO	L_aac_stop23
L__aac_stop61:
;aac.c,152 :: 		aac_currentState = STOPPING;
	MOV	#lo_addr(_aac_currentState), W1
	MOV.B	#6, W0
	MOV.B	W0, [W1]
L_aac_stop23:
...
;aac.c,155 :: 		void aac_updateExternValue(const aac_values id, const int value){
;aac.c,156 :: 		if(id < AAC_NUM_VALUES)
	CP.B	W10, #3
	BRA LTU	L__aac_updateExternValue63
	GOTO	L_aac_updateExternValue24
L__aac_updateExternValue63:
;aac.c,157 :: 		aac_externValues[id] = value;
	ZE	W10, W0
	SL	W0, #1, W1
	MOV	#lo_addr(_aac_externValues), W0
	ADD	W0, W1, W0
...
;aac.c,160 :: 		int aac_getParam(const aac_params id){
;aac.c,161 :: 		if(id < AAC_NUM_PARAMS)
	CP.B	W10, #9
	BRA LTU	L__aac_getParam65
	GOTO	L_aac_getParam25
L__aac_getParam65:
;aac.c,162 :: 		return aac_parameters[id];
	ZE	W10, W0
	SL	W0, #1, W1
	MOV	#lo_addr(_aac_parameters), W0
	ADD	W0, W1, W0
...
;aac.c,166 :: 		int aac_getExternValue(const aac_params id){
;aac.c,167 :: 		if(id < AAC_NUM_VALUES)
	CP.B	W10, #3
	BRA LTU	L__aac_getExternValue67
	GOTO	L_aac_getExternValue26
L__aac_getExternValue67:
;aac.c,168 :: 		return aac_externValues[id];
	ZE	W10, W0
	SL	W0, #1, W1
	MOV	#lo_addr(_aac_externValues), W0
	ADD	W0, W1, W0
