...
void Can_init() {
    ...
    //*/
    CAN1SetMask(_CAN_MASK_B1, GCU_MASK_EFI_SW_EBB, _CAN_CONFIG_MATCH_MSG_TYPE & _CAN_CONFIG_STD_MSG);
    CAN1SetFilter(_CAN_FILTER_B1_F1, GCU_FILTER_EFI, _CAN_CONFIG_STD_MSG);
    CAN1SetFilter(_CAN_FILTER_B1_F2, GCU_FILTER_SW_DCU, _CAN_CONFIG_STD_MSG);
    /*
