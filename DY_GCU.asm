...
;DY_GCU.c,77 :: 		void main() {
;DY_GCU.c,78 :: 		init();
	CALL	_init
;DY_GCU.c,79 :: 		Buzzer_Bip();
	CALL	_Buzzer_Bip
;DY_GCU.c,81 :: 		while (1)
L_main0:
;DY_GCU.c,84 :: 		Delay_ms(1000);
	MOV	#102, W8
	MOV	#47563, W7
L_main2:
	DEC	W7
...
;DY_GCU.c,118 :: 		dSignalLed_switch(DSIGNAL_LED_RG14);
	CLR	W10
	CALL	_dSignalLed_switch
;DY_GCU.c,120 :: 		sendTempSensor();
...
;DY_GCU.c,172 :: 		Buzzer_Bip();
	CALL	_Buzzer_Bip
;DY_GCU.c,173 :: 		break;
	GOTO	L_CAN_Interrupt15
;DY_GCU.c,189 :: 		case SW_GEARSHIFT_ID:
L_CAN_Interrupt18:
;DY_GCU.c,190 :: 		GearShift_injectCommand(firstInt);
	MOV	[W14+0], W10
