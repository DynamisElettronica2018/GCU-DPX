...
;DY_GCU.c,112 :: 		onCanInterrupt{
;DY_GCU.c,117 :: 		Can_read(&id, dataBuffer, &dataLen, &flags);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	...
	MOV	W0, W10
	CALL	_Can_read
;DY_GCU.c,118 :: 		Can_clearInterrupt();
	CALL	_Can_clearInterrupt
;DY_GCU.c,120 :: 		if (dataLen >= 2) {
	MOV	[W14+14], W0
	CP	W0, #2
	BRA GEU	L__CAN_Interrupt41
	GOTO	L_CAN_Interrupt7
L__CAN_Interrupt41:
;DY_GCU.c,121 :: 		firstInt = (unsigned int) ((dataBuffer[0] << 8) | (dataBuffer[1] & 0xFF));
	ADD	W14, #6, W1
	MOV.B	[W1], W0
	ZE	W0, W0
	SL	W0, #8, W2
...
;DY_GCU.c,131 :: 		}
L_CAN_Interrupt10:
;DY_GCU.c,134 :: 		switch (id) {
	GOTO	L_CAN_Interrupt11
;DY_GCU.c,135 :: 		case EFI_GEAR_RPM_TPS_APPS_ID:
L_CAN_Interrupt13:
;DY_GCU.c,136 :: 		GearShift_setCurrentGear(firstInt);
	MOV	[W14+0], W10
	CALL	_GearShift_setCurrentGear
;DY_GCU.c,137 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,139 :: 		case SW_FIRE_GCU_ID:
L_CAN_Interrupt14:
;DY_GCU.c,141 :: 		EngineControl_resetStartCheck();           //resetCheckCounter = 0
	CALL	_EngineControl_resetStartCheck
;DY_GCU.c,142 :: 		EngineControl_start();                     //debug on LED D2 board
	CALL	_EngineControl_start
;DY_GCU.c,144 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,146 :: 		case SW_GEARSHIFT_ID:
L_CAN_Interrupt15:
;DY_GCU.c,147 :: 		GearShift_injectCommand(firstInt);
	MOV	[W14+0], W10
	CALL	_GearShift_injectCommand
;DY_GCU.c,148 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,151 :: 		case SW_CLUTCH_TARGET_GCU_ID:
L_CAN_Interrupt16:
;DY_GCU.c,153 :: 		if ((!gearShift_isShiftingDown && !gearShift_isSettingNeutral) || gearShift_isUnsettingNeutral) {
...
L__CAN_Interrupt25:
L__CAN_Interrupt29:
;DY_GCU.c,155 :: 		Clutch_setBiased(dataBuffer[0]);
	ADD	W14, #6, W0
	MOV.B	[W0], W10
...
;DY_GCU.c,158 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,160 :: 		case EFI_HALL_ID:
L_CAN_Interrupt22:
;DY_GCU.c,162 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,164 :: 		case SW_DRS_GCU_ID:
L_CAN_Interrupt23:
;DY_GCU.c,178 :: 		default:
L_CAN_Interrupt24:
;DY_GCU.c,179 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,180 :: 		}
