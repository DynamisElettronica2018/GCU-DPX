...
;DY_GCU.c,31 :: 		void GCU_isAlive(void) {
;DY_GCU.c,32 :: 		Can_resetWritePacket();
	PUSH	W10
	PUSH	W11
	CALL	_Can_resetWritePacket
;DY_GCU.c,33 :: 		Can_addIntToWritePacket((unsigned int)CAN_COMMAND_GCU_IS_ALIVE);
	MOV	#99, W10
	CALL	_Can_addIntToWritePacket
;DY_GCU.c,34 :: 		Can_addIntToWritePacket((unsigned int)(Clutch_get() | 0 ));
	CALL	_Clutch_get
	ZE	W0, W0
	MOV	W0, W10
	CALL	_Can_addIntToWritePacket
...
;DY_GCU.c,36 :: 		Can_addIntToWritePacket(0);
	CLR	W10
	CALL	_Can_addIntToWritePacket
;DY_GCU.c,37 :: 		Can_write(GCU_CLUTCH_FB_SW_ID);
	MOV	#784, W10
	MOV	#0, W11
	CALL	_Can_write
;DY_GCU.c,39 :: 		}
...
;DY_GCU.c,43 :: 		void init(void) {
;DY_GCU.c,44 :: 		EngineControl_init();
	PUSH	W10
	PUSH	W11
	PUSH	W12
	CALL	_EngineControl_init
;DY_GCU.c,45 :: 		dSignalLed_init();
	CALL	_dSignalLed_init
;DY_GCU.c,46 :: 		Can_init();
	CALL	_Can_init
;DY_GCU.c,47 :: 		GearMotor_init();
	CALL	_GearMotor_init
;DY_GCU.c,48 :: 		ClutchMotor_init();
	CALL	_ClutchMotor_init
;DY_GCU.c,49 :: 		Efi_init();
	CALL	_Efi_init
;DY_GCU.c,50 :: 		GearShift_init();
	CALL	_GearShift_init
;DY_GCU.c,51 :: 		StopLight_init();
	CALL	_StopLight_init
;DY_GCU.c,52 :: 		Buzzer_init();
	CALL	_Buzzer_init
;DY_GCU.c,55 :: 		traction_init();
	CALL	_traction_init
;DY_GCU.c,59 :: 		setTimer(TIMER1_DEVICE, 0.001);
	MOV	#4719, W11
	MOV	#14979, W12
	MOV.B	#1, W10
	CALL	_setTimer
;DY_GCU.c,60 :: 		setInterruptPriority(TIMER1_DEVICE, MEDIUM_PRIORITY);
	MOV.B	#4, W11
	MOV.B	#1, W10
...
;DY_GCU.c,63 :: 		void main() {
;DY_GCU.c,64 :: 		init();
	CALL	_init
;DY_GCU.c,65 :: 		Buzzer_Bip();
	CALL	_Buzzer_Bip
;DY_GCU.c,67 :: 		while (1)
L_main0:
;DY_GCU.c,71 :: 		bello += 1;
...
;DY_GCU.c,77 :: 		onTimer1Interrupt{
;DY_GCU.c,78 :: 		clearTimer1();
	PUSH	W10
	BCLR	IFS0bits, #3
;DY_GCU.c,79 :: 		GearShift_msTick();
	CALL	_GearShift_msTick
;DY_GCU.c,81 :: 		timer1_counter0 += 1;
	MOV	#1, W1
	MOV	#lo_addr(_timer1_counter0), W0
	ADD	W1, [W0], [W0]
;DY_GCU.c,82 :: 		timer1_counter1 += 1;
	MOV	#1, W1
	MOV	#lo_addr(_timer1_counter1), W0
	ADD	W1, [W0], [W0]
;DY_GCU.c,83 :: 		timer1_counter2 += 1;
	MOV	#1, W1
	MOV	#lo_addr(_timer1_counter2), W0
	ADD	W1, [W0], [W0]
;DY_GCU.c,84 :: 		timer1_counter3 += 1;
	MOV	#1, W1
	MOV	#lo_addr(_timer1_counter3), W0
	ADD	W1, [W0], [W0]
;DY_GCU.c,85 :: 		timer1_counter4 += 1;
	MOV	#1, W1
...
;DY_GCU.c,115 :: 		onCanInterrupt{
;DY_GCU.c,120 :: 		Can_read(&id, dataBuffer, &dataLen, &flags);
	PUSH	W10
	PUSH	W11
	PUSH	W12
	PUSH	W13
	...
	MOV	W0, W10
	CALL	_Can_read
;DY_GCU.c,121 :: 		Can_clearInterrupt();
	CALL	_Can_clearInterrupt
;DY_GCU.c,123 :: 		if (dataLen >= 2) {
	MOV	[W14+14], W0
	CP	W0, #2
	BRA GEU	L__CAN_Interrupt41
	GOTO	L_CAN_Interrupt7
L__CAN_Interrupt41:
;DY_GCU.c,124 :: 		firstInt = (unsigned int) ((dataBuffer[0] << 8) | (dataBuffer[1] & 0xFF));
	ADD	W14, #6, W1
	MOV.B	[W1], W0
	ZE	W0, W0
	SL	W0, #8, W2
...
;DY_GCU.c,134 :: 		}
L_CAN_Interrupt10:
;DY_GCU.c,137 :: 		switch (id) {
	GOTO	L_CAN_Interrupt11
;DY_GCU.c,138 :: 		case EFI_GEAR_RPM_TPS_APPS_ID:
L_CAN_Interrupt13:
;DY_GCU.c,139 :: 		GearShift_setCurrentGear(firstInt);
	MOV	[W14+0], W10
	CALL	_GearShift_setCurrentGear
;DY_GCU.c,140 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,142 :: 		case SW_FIRE_GCU_ID:
L_CAN_Interrupt14:
;DY_GCU.c,144 :: 		EngineControl_resetStartCheck();           //resetCheckCounter = 0
	CALL	_EngineControl_resetStartCheck
;DY_GCU.c,145 :: 		EngineControl_start();                     //debug on LED D2 board
	CALL	_EngineControl_start
;DY_GCU.c,147 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,149 :: 		case SW_GEARSHIFT_ID:
L_CAN_Interrupt15:
;DY_GCU.c,150 :: 		GearShift_injectCommand(firstInt);
	MOV	[W14+0], W10
	CALL	_GearShift_injectCommand
;DY_GCU.c,151 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,154 :: 		case SW_CLUTCH_TARGET_GCU_ID:
L_CAN_Interrupt16:
;DY_GCU.c,156 :: 		if ((!gearShift_isShiftingDown && !gearShift_isSettingNeutral) || gearShift_isUnsettingNeutral) {
...
L__CAN_Interrupt25:
L__CAN_Interrupt29:
;DY_GCU.c,158 :: 		Clutch_setBiased(dataBuffer[0]);
	ADD	W14, #6, W0
	MOV.B	[W0], W10
...
;DY_GCU.c,161 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,163 :: 		case EFI_HALL_ID:
L_CAN_Interrupt22:
;DY_GCU.c,165 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,168 :: 		case SW_TRACTION_CONTROL_GCU_ID:
L_CAN_Interrupt23:
;DY_GCU.c,171 :: 		tractionFb = firstInt;
	MOV	[W14+0], W0
	MOV	W0, _tractionFb
;DY_GCU.c,173 :: 		traction_currentState = tractionFb * 100;
	MOV	#100, W3
	ADD	W14, #0, W2
	MUL.UU	W3, [W2], W0
	MOV	W0, _traction_currentState
;DY_GCU.c,174 :: 		setTraction(TRACTION_CODE, traction_currentState);
	MOV	W0, W11
	MOV	#3, W10
	CALL	_setTraction
;DY_GCU.c,177 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,180 :: 		default:
L_CAN_Interrupt24:
;DY_GCU.c,181 :: 		break;
	GOTO	L_CAN_Interrupt12
;DY_GCU.c,182 :: 		}
